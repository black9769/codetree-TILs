...
|릴레이|문제|티어|유형|
|---|---|---|---|
|2|[패턴 출력하는 재귀함수](https://www.codetree.ai/training-field/search/problems/recursive-function-that-outputs-pattern)|![Silver5][s5]|`Recursive Function`|
|1|[규칙이 있는 재귀함수](https://www.codetree.ai/training-field/search/problems/recursive-function-with-rules)|![Silver5][s5]|`Recursive Function`|
